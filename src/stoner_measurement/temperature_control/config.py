...
from stoner_measurement.plugins.plugin_config import _deep_merge, _load_yaml_mapping
...
def load_temperature_controller_config() -> dict[str, Any]:
    ...
    bundled = _load_yaml_mapping(
        resources.files(_BUNDLED_CONFIG_PACKAGE).joinpath("temperature_controller.yaml")
    )
    machine = _load_yaml_mapping(machine_config_path())
    return _deep_merge(bundled, machine)
